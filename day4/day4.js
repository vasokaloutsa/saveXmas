...
const getInput = () => {
    ...
    if (passports[i].includes('byr') && passports[i].includes('iyr') && passports[i].includes('eyr') && passports[i].includes('hgt') && passports[i].includes('hcl') && passports[i].includes('ecl') && passports[i].includes('pid') && passports[i].includes('cid')){
        testOf1If++;
